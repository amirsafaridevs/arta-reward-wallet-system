...
class AccountDetails extends AbstractService
{
    ...
    public function displayIncompleteProfilePopup(): void
    {
        ...
        $enablePopup = get_option('arta_enable_popup', 1);
        ...
        // Get popup message from settings
        $message = get_option('arta_popup_message', 'با تکمیل اطلاعات حساب خود پاداش بگیرید');
        ...
        // Display popup using view
        Application::view('profile-popup', [
            'message' => $message,
